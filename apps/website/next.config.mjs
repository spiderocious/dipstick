...
const nextConfig = {
  ...
  transpilePackages: ['@dipstick/ui', '@dipstick/core'],
  webpack: (config) => {
    config.resolve.alias = {
      ...(config.resolve.alias ?? {}),
      '@dipstick/ui': path.resolve(__dirname, '../../packages/ui/src/index.ts'),
      '@dipstick/core': path.resolve(__dirname, '../../packages/core/src/index.ts'),
